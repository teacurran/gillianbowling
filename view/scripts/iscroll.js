...
function iScroll (el, options) {
	...
	this.fixedWidth = parseInt(this.element.style.width);
...
iScroll.prototype = {
	...
	refresh: function () {
		...
		this.maxScrollX = this.scrollWidth - this.fixedWidth;
		...
		//alert(this.fixedWidth + ":" + this.scrollWidth + ":" + this.element.offsetWidth);
		//if (this.fixedWidth > this.scrollWidth) {
		//	alert("im here1");
		//} else {
		//	alert("im here2");
		//}
		this.scrollX = this.fixedWidth > this.scrollWidth;
		...
		if (this.options.hScrollBar && this.scrollX) {
			...
			this.scrollBarX.init(this.scrollWidth, this.fixedWidth);
...
*/
		...
		var momentumX = this.scrollX === true
			? this.momentum(this.x - this.scrollStartX,
							...
							this.options.bounce ? this.x + this.fixedWidth - this.scrollWidth + this.scrollWidth/3 : this.x + this.fixedWidth - this.scrollWidth)
			: { dist: 0, time: 0 };
