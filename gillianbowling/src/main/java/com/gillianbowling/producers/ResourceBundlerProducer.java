...
import com.scholastic.intl.bookmanager.locales.UTF8ResourceBundleControl;
import com.scholastic.intl.bookmanager.qualifiers.ClasspathResource;
import com.scholastic.intl.bookmanager.qualifiers.Localization;
...
public class ResourceBundleProducer {
	...
	public ResourceBundle getLocalization() {
		...
		return ResourceBundle.getBundle("com.scholastic.intl.bookmanager.locales.I18n", locale, new UTF8ResourceBundleControl());
	}
